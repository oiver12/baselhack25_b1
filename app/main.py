...
async def startup_event():
    ...
    if settings.DISCORD_BOT_TOKEN:
        ...
        for _ in range(60):  # 60 * 0.5s = 30s
            ...
            print("⚠️  Warning: Bot not ready after 30 seconds, skipping historical message fetch")
            return
                ...
                if new_messages:
                    ...
                    for qid in question_ids:
                        try:
                            ...
                            print(f"⚠️  Warning: Failed to process messages for question {qid}: {e}")
        ...
        print("⚠️  Warning: DISCORD_BOT_TOKEN not set, skipping Discord bot startup")
